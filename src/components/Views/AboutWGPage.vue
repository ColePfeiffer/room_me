...
export default {
          ...
          pastRoomies: [
            {
              ...
              type: "DUMMY",
              description: "Hi there!",
              profilePicture: "https://i.imgur.com/PwDoshF.jpeg",
              //profilePicture: "https://i.imgur.com/8FcQuUZ.gif",
              showProfilePage: false,
              movedOut: true,
              moveInDate: new Date(2015, 10, 15),
              moveOutDate: new Date(2017, 5, 3)
            },
            {
              ...
              username: "Deh",
              description: "Möpp",
              profilePicture: "https://i.imgur.com/eZ6KzxL.jpeg",
              showProfilePage: false,
              movedOut: true,
              moveInDate: new Date(2013, 10, 15),
              moveOutDate: new Date(2015, 5, 3)
            }
          ]
        },
        {
          ...
          pastRoomies: [
            {
              ...
              username: "Merle",
              description: "Hi there!",
              profilePicture: "https://i.imgur.com/hLms9mt.gif",
              balance: +3,
              balancePlus: true,
              selected: true,
              color: "#1F85DE",
  ...
  methods: {
    ...
    createDummy(array) {
      ...
      // add dummy as currentRoomie
      let currentRoomieRef = this.rooms.find(room => room.id === roomSelection)
        .currentRoomie;

      console.log(currentRoomieRef);
      currentRoomieRef = dummy;
    }
  }
};
</script>
